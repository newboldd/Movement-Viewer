#!/usr/bin/env bash
# Update the icon for Movement Viewer.app from a single source image.
#
# Usage:
#   ./update_app_icon.sh path/to/new_icon.png
#
...
#   3. Drop the new icns into Movement Viewer.app/Contents/Resources/.
...
APP="$REPO_ROOT/Movement Viewer.app"
